...
const faqs = [
  ...
  { question: "How do I pay in South African Rand (ZAR)?", answer: "We accept EFT / direct bank transfer from any South African bank. All prices are displayed in ZAR with no hidden import fees." },
  ...
  { question: "What peptides do you stock for weight loss?", answer: "We stock semaglutide, tirzepatide (TZ2-Tirz), and retatrutide (GGG-3) — the three most clinically researched GLP-1 class peptides for weight management. We also carry MOTS-c for metabolic support." },
