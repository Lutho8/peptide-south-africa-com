    ...
    try {
      ...
      if (result.error) {
        toast({
          ...
          description: result.error.message || "Please try again or use email.",
          variant: "destructive",
        });
        return;
      }
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <label className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-input bg-background py-3 pl-10 pr-3 text-base focus:outline-none focus:ring-2 focus:ring-ring sm:text-sm"
            />
          </label>
          <label className="relative">
          ...
          <button
            disabled={busy}
            className="mt-2 flex min-h-[48px] items-center justify-center gap-2 rounded-lg bg-hero-gradient py-3 text-sm font-semibold text-primary-foreground shadow-glow hover:opacity-90 disabled:opacity-60"
          >
