...
const PRODUCT_LD = {
  ...
  "additionalProperty": [
    ...
    { "@type": "PropertyValue", "name": "Category", "value": "GLP-1 / GIP / Glucagon triple agonist" },
...
const BREADCRUMB_LD = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Buy Retatrutide in South Africa" }
  ]
};

export default function BuyRetatrutideSA() {
  return (
    <>
      <SEO
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6">
          ...
          <nav className="text-sm text-muted-foreground mb-8">
            ...
            <span className="mx-2">/</span>
            <span className="text-foreground">Buy Retatrutide in South Africa</span>
          </nav>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 sm:p-8 mb-8 shadow-card">
            <div className="flex items-start justify-between mb-6">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold text-foreground">R1250</p>
