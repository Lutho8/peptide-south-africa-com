...
export const post: BlogPost = {
  ...
  body: [
    ...
    {
      type: "p",
      text: "TRIUMPH-1 randomised 2,339 adults with obesity or overweight plus at least one weight-related comorbidity (and without diabetes) 1:1:1:1 to retatrutide 4 mg, 9 mg, 12 mg, or placebo. Baseline mean body weight was 112.7 kg (248.5 lbs) at a mean BMI of 40.0.<sup>1</sup>",
    },
    {
      type: "callout",
      title: "Headline results at 80 weeks (efficacy estimand)",
      text: "Retatrutide 4 mg: −19.0% (−47.2 lbs). 9 mg: −25.9% (−64.4 lbs). 12 mg: −28.3% (−70.3 lbs). Placebo: −2.2% (−5.5 lbs).",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "<strong>Dysesthesia</strong> (altered sensation) occurred in 5.1%, 12.3% and 12.5% of the 4 mg, 9 mg and 12 mg arms respectively (vs 0.9% placebo). Events were generally mild-to-moderate and mostly resolved on treatment.",
    },
    {
      type: "p",
      text: "<strong>Urinary tract infections</strong> occurred in 7.5–8.8% of retatrutide arms vs 5.3% placebo. Most events were mild-to-moderate and resolved during treatment.",
    },
    {
      type: "p",
  ...
  faqs: [
    {
      q: "Is retatrutide approved or available?",
      a: "No. Retatrutide is an investigational molecule. Per Lilly's 21 May 2026 release, it is legally available only to participants in Lilly's clinical trials and has not been approved by any regulator.",
    },
    {
