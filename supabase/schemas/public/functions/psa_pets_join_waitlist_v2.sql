CREATE OR REPLACE FUNCTION public.psa_pets_join_waitlist_v2 (
  ...
  p_consent_version                   text    DEFAULT 'pets-research-interest-2026-09-01'::text,
...
GRANT EXECUTE
  ON FUNCTION "public"."psa_pets_join_waitlist_v2"(text, text, text, text, text, text, integer, text, jsonb, text, text, text, text, boolean, boolean, boolean, text, jsonb, jsonb)
